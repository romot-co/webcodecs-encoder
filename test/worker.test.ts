...
import { EncoderConfig, InitializeWorkerMessage, FinalizeWorkerMessage, CancelWorkerMessage } from '../src/types';
...
describe('worker', () => {
  ...
  beforeEach(async () => {
    ...
    mockSelf.VideoEncoder = {
      isConfigSupported: vi.fn(() => Promise.resolve({ supported: true, config: {} })),
    ...
    if (typeof globalThis.VideoFrame === 'undefined') {
        globalThis.VideoFrame = class VideoFrameMock {
            constructor(source: any, init: any) { Object.assign(this, init); this.source = source; }
            close() {}
  ...
  afterEach(() => {
    ...
    if ((globalThis as any).AudioData?.name === 'AudioDataMock') delete (globalThis as any).AudioData;
  });
